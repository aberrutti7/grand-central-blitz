...
export const config = {
    ...
    paytable: [
        ...
        { id: 2, name: "High 2", texture: "sym_2_h3", tier: "high", payouts: { 3: 5  } },
        { id: 3, name: "High 3", texture: "sym_3_h3", tier: "high", payouts: { 3: 4  } },
        { id: 4, name: "High 4", texture: "sym_4_h3", tier: "high", payouts: { 3: 3  } },
        { id: 5, name: "Low 1",  texture: "sym_5_h3", tier: "low",  payouts: { 3: 2  } },
        { id: 6, name: "Low 2",  texture: "sym_6_h3", tier: "low",  payouts: { 3: 1.5  } },
